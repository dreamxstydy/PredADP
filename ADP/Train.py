...
from .Mertics import scores,train_result
Path(f'./Models/Train/bestTrain/').mkdir(exist_ok=True, parents=True)
def L_Model(file):
    file_name = 'LR.txt'
    model_name = "LR"
    ...
    for train_index, test_index in skf.split(X, y):
        ...
        scorel = scores(test_Y,y_pred,th=0.5)
        result_LR.append(scorel)
    joblib.dump(clf,f'./Models/Train/bestTrain/{model_name}.model')
